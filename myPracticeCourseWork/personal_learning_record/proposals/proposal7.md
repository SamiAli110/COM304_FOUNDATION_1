...
<table> <tr> <th>Strength</th> <th>Weakness</th> </tr> <tr> <td> <ol> <li>Dramatically faster development cycles.</li> <li>Reduced reliance on specialist programmers.</li> <li>Allows staff to build tools that meet their real needs.</li> </ol> </td> <td> <ol> <li>Complex applications may exceed LCNC capabilities.</li> <li>Risk of poorly designed “shadow IT” applications.</li> <li>Staff training and culture shift required.</li> </ol> </td> </tr> <tr> <th>Opportunity</th> <th>Threat</th> </tr> <tr> <td> <ol> <li>Accelerates digital transformation.</li> <li>Improves collaboration between departments.</li> <li>Enables rapid prototyping and innovation.</li> </ol> </td> <td> <ol> <li>Security vulnerabilities in user-created apps.</li> <li>Over-reliance on a single LCNC vendor.</li> <li>Integration issues with legacy systems.</li> </ol> </td> </tr> </table>

### PEST Analysis
*You can use html tables in markdown*
<table> <tr> <th>Political</th> <th>Economic</th> </tr> <tr> <td> <ol> <li>Supports government expectations for innovation.</li> <li>Improves transparency and service delivery speed.</li> <li>Encourages digital inclusion among council staff.</li> </ol> </td> <td> <ol> <li>Reduces long-term software development costs.</li> <li>Lower dependency on expensive external contractors.</li> <li>Initial training and licensing costs may apply.</li> </ol> </td> </tr> <tr> <th>Social</th> <th>Technological</th> </tr> <tr> <td> <ol> <li>Empowers staff to solve problems independently.</li> <li>Improves responsiveness to community needs.</li> <li>Encourages collaboration across departments.</li> </ol> </td> <td> <ol> <li>Supports modern cloud-based architectures.</li> <li>Integrates with APIs and existing databases.</li> <li>Enables rapid deployment of new digital services.</li> </ol> </td> </tr> </table>
...
Allowing councillors to work remotely through a secure VPN 
