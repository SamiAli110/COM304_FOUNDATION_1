...
*You can use html tables in markdown*
 ...
 <table>
  ...
  <tr>
    <td>
      <ol>
        <li>Supports modern government remote working guidance</li>
        <li>Ensures councillors can continue work during building closure</li>
        <li>Must comply with GDPR when accessing data remotely.</li>
      </ol> 
    </td>
    <td>
      <ol>
        <li>Reduces need of office based equipment</li>
        <li>Lower travel expenses</li>
        <li>initial cost may occur for traning and VPN licensing</li>
      </ol> 
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td>
      <ol>
        <li>Encourges flexability</li>
        <li>Improves councillor availabilty for consituents</li>
        <li>Supports digital inclusion for public engagment</li>
      </ol> 
    </td>
    <td>
      <ol>
        <li>Leverages modern ecryption</li>
        <li>Integrates with cloud idenity systems</li>
        <li>Supports secure access from multiple devices</li>
      </ol> 
    </td>
  </tr>
</table> 
